...
public class CashOrderMapperTest extends AsfsAdapterBaseTest {
  ...
  public void testCreateCashOrder() {
    SrvCreateCashOrderRq request = CashOrderMapper.INSTANCE.createCashOrderRq(cashOrder);
  ...
  public void testUpdStCashOrder() {
    SrvUpdStCashOrderRq request = CashOrderMapper.INSTANCE.updStCashOrderRq(cashOrder);
    assertHeaderInfo(request.getHeaderInfo());
  ...
  public void testConvertSrvCreateCashOrderRs() {
    CashOrder cashOrder = CashOrderMapper.INSTANCE.convert(response1);
    testCreate(cashOrder);
  }

  @Test
  public void testConvertSrvUpdStCashOrderRs() {
    CashOrder cashOrder = CashOrderMapper.INSTANCE.convert(response2);
